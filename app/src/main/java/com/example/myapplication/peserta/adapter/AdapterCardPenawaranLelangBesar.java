...
public class AdapterCardPenawaranLelangBesar extends RecyclerView.Adapter <AdapterCardPenawaranLelangBesar.ViewHolderPenawaranLelang> {
    ...
    public AdapterCardPenawaranLelangBesar(Context context, ArrayList<KatalogModel> itemList) {
    ...
    public ViewHolderPenawaranLelang onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.item_penawaran_lelang_besar,parent,false);
